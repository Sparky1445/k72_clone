...
import { loadOutAnimation, closeButtonAnimationOut } from './gsap.js'

const CloseButton = () => {


    return (
        <div onClick={()=> { loadOutAnimation() ; closeButtonAnimationOut()}}  className='opacity-0 invisible closeButton fixed top-0 right-1 z-12'>
