...
const Home = () => {
    ...
    return (
        ...
        <div>
            ...
            <div className='fixed w-full top-[0px]  flex justify-between flex-row'>
            <button className='left-3 fill-white'>
            <svg className='top-2 left-3 fill-white' xmlns="http://www.w3.org/2000/svg" width="120" height="60" viewBox="0 0 103 44">
            ...
            <button className='w-54 h-12 bg-black' >
            ...
            <div className='fixed w-[250px] left-4 bottom-[0px]  flex items-center  flex-row' >
        ...
        <span className=' font-weight-700 text-[20px] text-white'>MONTREAL_</span>
